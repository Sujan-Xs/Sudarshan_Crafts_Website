...
export default function About() {
  return (
    <section className="py-24 px-6 md:px-12 bg-[#DFD3C3] relative">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div id="about" className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-normal text-brand-charcoal" style={{ fontFamily: '"Playfair Display", serif' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <div className="border-b border-brand-bronze/20 pb-4">
              <h3 className="text-2xl font-serif font-medium text-brand-charcoal" style={{ fontFamily: '"Playfair Display", serif' }}>Sudarshan Crafts Museum</h3>
            </div>

            <div className="space-y-6">
              <div>
                <h4 className="text-[10px] tracking-[0.2em] uppercase text-brand-bronze mb-2">Established</h4>
                <p className="text-sm text-black font-medium leading-relaxed" style={{ fontFamily: '"Playfair Display", serif' }}>
          ...
          >
            <div className="border-b border-brand-bronze/20 pb-4">
              <h3 className="text-2xl font-serif font-medium text-brand-charcoal" style={{ fontFamily: '"Playfair Display", serif' }}>Sudarshan Arts and Crafts Village</h3>
            </div>
